 ...
 * Note:
 * 
 * The number of stones is &ge; 2 and is < 1,100. Each stone's position will be a non-negative
 * integer < 231. The first stone's position is always 0.
 * 
 * 
 * 
 * Example 1:
 ...
 * 
 * Return true. The frog can jump to the last stone by jumping 1 unit to the 2nd stone, then 2 units
 * to the 3rd stone, then 2 units to the 4th stone, then 3 units to the 6th stone, 4 units to the
 ...
 * [0,1,2,3,4,8,9,11]
 * 
 * Return false. There is no way to jump to the last stone as the gap between the 5th and 6th stone
 * is too large.
 * </pre>
 * 
