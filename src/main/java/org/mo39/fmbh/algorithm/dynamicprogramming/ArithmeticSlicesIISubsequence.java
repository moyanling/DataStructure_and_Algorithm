 ...
 * 
 * For example, these are arithmetic sequences: 1, 3, 5, 7, 9 7, 7, 7, 7 3, -1, -5, -9
 * 
 * The following sequence is not arithmetic. 1, 1, 2, 5, 7
 * 
 * 
 * A zero-indexed array A consisting of N numbers is given. A subsequence slice of that array is any
 * sequence of integers (P0, P1, ..., Pk) such that 0 &le; P0 < P1 < ... < Pk < N.
 * 
 * A subsequence slice (P0, P1, ..., Pk) of array A is called arithmetic if the sequence A[P0],
 * A[P1], ..., A[Pk-1], A[Pk] is arithmetic. In particular, this means that k &ge; 2.
 * 
 ...
 * Output: 7
 * 
 * Explanation: All arithmetic subsequence slices are: [2,4,6] [4,6,8] [6,8,10] [2,4,6,8] [4,6,8,10]
 * [2,4,6,8,10] [2,6,10]
 * </pre>
 * 
