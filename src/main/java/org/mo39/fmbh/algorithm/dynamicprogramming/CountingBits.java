 ...
 * calculate the number of 1's in their binary representation and return them as an array.<br/>
 * Example:<br/>
 ...
 * in linear time O(n) /possibly in a single pass?<br/>
 ...
 * from previous.<br/>
 * Or does the odd/even status of the number help you in calculating the number of 1s?<br/>
 * 
