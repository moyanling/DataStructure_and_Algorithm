...
public class Answer {
	...
	public static void main(String[] args) {
		Z.print(Arrays.toString(answer(new int[][] { { 0, 1, 0, 0, 0, 1 }, { 4, 0, 0, 3, 2, 0 }, { 0, 0, 0, 0, 0, 0 },
	...
	public static class Fraction {
		...
		public Fraction minus(Fraction toMinus) {
			return new Fraction(this.numerator * toMinus.denominator - toMinus.numerator * this.denominator,
					this.denominator * toMinus.denominator);
		}

		public Fraction divide(Fraction toDivide) {
			return new Fraction(this.numerator * toDivide.denominator, toDivide.numerator * this.denominator);
		}
