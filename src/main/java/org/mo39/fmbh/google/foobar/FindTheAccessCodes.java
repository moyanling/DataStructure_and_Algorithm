 ...
 *
 */
public enum FindTheAccessCodes {
  ...
  public abstract int solve(int[] l);

  public static class TestFindTheAccessCodes {

    @Test
    public void testSolutions() {
      Assert.assertEquals(22, SOLUTION.solve(new int[] {1, 2, 3, 4, 5, 6, 12, 24}));
    }
