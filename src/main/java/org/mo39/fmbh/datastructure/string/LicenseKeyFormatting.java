 ...
 * first group, which could be shorter, but still must contain at least one character).
 ...
 * </pre>
 * 
 * @see <a href="https://leetcode.com/problems/license-key-formatting/">License Key Formatting</a>
 * @author Jihan Chen
 */
...
public enum LicenseKeyFormatting {
  ...
  SOLUTION {
    ...
    public String solve(String S, int K) {
      ...
      for (int i = arr.length - 1, count = 0; i > -1; i--) {
        if (arr[i] == '-') continue;
  ...
  public abstract String solve(String S, int K);
